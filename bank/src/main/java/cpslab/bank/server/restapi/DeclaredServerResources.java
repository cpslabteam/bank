...
import cpslab.bank.server.restapi.resources.account.AccountBranchResource;
import cpslab.bank.server.restapi.resources.account.AccountOwnerResource;
import cpslab.bank.server.restapi.resources.account.AccountOwnersResource;
import cpslab.bank.server.restapi.resources.account.AccountResource;
import cpslab.bank.server.restapi.resources.account.AccountsResource;
import cpslab.bank.server.restapi.resources.borrower.BorrowerResource;
import cpslab.bank.server.restapi.resources.borrower.BorrowersResource;
import cpslab.bank.server.restapi.resources.branch.BranchAccountResource;
import cpslab.bank.server.restapi.resources.branch.BranchAccountsResource;
import cpslab.bank.server.restapi.resources.branch.BranchLoanResource;
import cpslab.bank.server.restapi.resources.branch.BranchLoansResource;
import cpslab.bank.server.restapi.resources.branch.BranchResource;
import cpslab.bank.server.restapi.resources.branch.BranchesResource;
import cpslab.bank.server.restapi.resources.customer.CustomerAccountDepositResource;
import cpslab.bank.server.restapi.resources.customer.CustomerAccountResource;
import cpslab.bank.server.restapi.resources.customer.CustomerAccountWithdrawResource;
import cpslab.bank.server.restapi.resources.customer.CustomerAccountsResource;
import cpslab.bank.server.restapi.resources.customer.CustomerLoanDepositResource;
import cpslab.bank.server.restapi.resources.customer.CustomerLoanResource;
import cpslab.bank.server.restapi.resources.customer.CustomerLoansResource;
import cpslab.bank.server.restapi.resources.customer.CustomerResource;
import cpslab.bank.server.restapi.resources.customer.CustomersResource;
import cpslab.bank.server.restapi.resources.depositor.DepositorResource;
import cpslab.bank.server.restapi.resources.depositor.DepositorsResource;
import cpslab.bank.server.restapi.resources.loan.LoanBranchResource;
import cpslab.bank.server.restapi.resources.loan.LoanOwnerResource;
import cpslab.bank.server.restapi.resources.loan.LoanOwnersResource;
import cpslab.bank.server.restapi.resources.loan.LoanResource;
import cpslab.bank.server.restapi.resources.loan.LoansResource;
