...
public class NewRestActivator extends Application {

	private static Logger logger = LoggerFactory.getLogger(NewRestActivator.class);

	private static Component component;

	private static final NewRestActivator singleton = new NewRestActivator();
	...
	public static NewRestActivator getInstance() {
		return singleton;
	}
