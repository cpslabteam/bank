...
public class LoanDAOHibernate extends HibernateDAO<Loan, Long>implements LoanDAO {
	...
	private final static String CUSTOMER_LOANS_QUERY = "SELECT l FROM Customer c JOIN c.loans l WHERE c.id = :id";
	private final static String CUSTOMER_LOAN_QUERY = "SELECT l FROM Customer c JOIN c.loans l WHERE c.id = :customer_id AND l.id = :loan_id";
